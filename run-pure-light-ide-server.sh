...
CONFIG_LOC=$HOME/pure/legend-engine/legend-engine-pure/legend-engine-pure-ide/legend-engine-pure-ide-light/src/main/resources/ideLightConfig.json
...
cd $PURELOC && mvn -pl legend-engine-pure/legend-engine-pure-ide/legend-engine-pure-ide-light exec:java -Dexec.mainClass="org.finos.legend.engine.ide.PureIDELight" -Dexec.args="server ${CONFIG_LOC}"
